...
const ReviewStep: React.FC<ReviewStepProps> = ({ form, onPublish, onSaveDraft, onEditSection }) => {
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.instructionCard}>
          ...
          <View style={styles.instructionTextContent}>
            <AppText style={styles.instructionTitle}>Review your shipment details</AppText>
        ...
        <View style={styles.banner}>
          <AppText style={styles.bannerText}>Total horses : {form.numberOfHorses || 1}</AppText>
        </View>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.detailRow}>
            ...
            <AppText style={styles.detailText}>{form.pickupLocation || 'Address Name here'}</AppText>
          </View>
          <View style={styles.detailRow}>
            <CalendarIcon size={18} color={COLORS.primary} />
            <AppText style={styles.detailText}>On {formatDate(form.pickupStartDate)}</AppText>
          </View>
          ...
          <View style={styles.detailRow}>
            <MapPin size={18} color={COLORS.primary} />
            <AppText style={styles.detailText}>{form.deliveryLocation || 'Address Name here'}</AppText>
          </View>
          <View style={styles.detailRow}>
            <CalendarIcon size={18} color={COLORS.primary} />
            <AppText style={styles.detailText}>before {formatDate(form.deliveryEndDate)}</AppText>
          </View>
        ...
        >
          ...
          {isHorseExpanded ? <ChevronUp size={20} color={COLORS.textPrimary} /> : <ChevronDown size={20} color={COLORS.textPrimary} />}
        </TouchableOpacity>
        ...
        {isHorseExpanded && (
          <View style={styles.horseDetailsContainer}>
            ...
            <InfoRow label="Registered Name" value={form.horses[0].registeredName} />
            ...
            <InfoRow label="Special Needs" value={form.hasSpecialRequirement ? 'Yes' : 'No'} />
            
            <View style={styles.notesContainer}>
                <AppText style={styles.infoLabel}>Additional Information: </AppText>
                <AppText style={styles.notesText}>{form.generalNotes || 'None provided.'}</AppText>
            </View>
...
const styles = StyleSheet.create({
  ...
  instructionSub: { fontSize: 13, fontFamily: FONTS.regular, color: COLORS.textSecondary, lineHeight: 18 },

  banner: { backgroundColor: COLORS.goldLightBg, padding: 12, borderRadius: RADIUS.sm, marginBottom: SPACING.md },
  ...
  detailText: { fontFamily: FONTS.regular, fontSize: 14, color: COLORS.textSecondary },
  editBtn: {
  ...
  editBtnText: { color: COLORS.white, fontFamily: FONTS.semiBold, fontSize: 13 },
  ...
  horseSubHeader: { fontFamily: FONTS.bold, fontSize: 12, color: COLORS.grey500, marginBottom: 12, letterSpacing: 1 },
  
  infoRow: { flexDirection: 'row', marginBottom: 8 },
  infoLabel: { fontFamily: FONTS.bold, color: COLORS.textPrimary, fontSize: 14 },
  infoValue: { fontFamily: FONTS.regular, color: COLORS.textSecondary, fontSize: 14 },
  
  notesContainer: { marginTop: 4, marginBottom: 16 },
  notesText: { fontFamily: FONTS.regular, color: COLORS.textSecondary, fontSize: 14, marginTop: 4, lineHeight: 20 },
