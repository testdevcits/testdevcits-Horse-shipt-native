...
import { AppLoader, AppText, EmptyState, ReviewCard } from '../../../../components';
    ...
    const renderSummary = () => (
        <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryText}>
                ...
                <AppText style={styles.summarySub}>Based on {reviews.length} shipper reviews</AppText>
            </View>
        </View>
    );
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                ...
                refreshControl={
                    <RefreshControl refreshing={loading} onRefresh={fetchReviews} tintColor={COLORS.goldPrimary} />
                }
                ListEmptyComponent={
                    <EmptyState
                        icon={MessageCircle}
...
const styles = StyleSheet.create({
    ...
    summaryCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.goldPrimary, borderRadius: RADIUS.lg, padding: SPACING.lg, marginBottom: SPACING.xl },
    ratingCircle: { width: 60, height: 60, borderRadius: 30, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center' },
