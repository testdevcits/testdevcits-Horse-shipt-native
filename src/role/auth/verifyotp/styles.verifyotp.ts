...
const styles= StyleSheet.create({
  ...
  logoInnerRing: {
    ...
    justifyContent: 'center', alignItems: 'center', borderWidth: 1.5, borderColor: COLORS.goldPrimary,
  },
  ...
  activeBox: { borderColor: COLORS.goldPrimary, borderWidth: 2, backgroundColor: COLORS.white },
  ...
  resendLink: { fontSize: 14, fontFamily: FONTS.bold, color: COLORS.goldPrimary },
  
  submitBtn: { backgroundColor: COLORS.goldPrimary, height: 56, borderRadius: RADIUS.md, marginTop: SPACING.xl },
});
